...
/*----------------------
  ...
  following definitions are in dSFMT-paramsXXXX.hpp file.
  ----------------------*/
...
#if DSFMT_MEXP == 521
  #include "dSFMT-params521.hpp"
#elif DSFMT_MEXP == 1279
  #include "dSFMT-params1279.hpp"
#elif DSFMT_MEXP == 2203
  #include "dSFMT-params2203.hpp"
#elif DSFMT_MEXP == 4253
  #include "dSFMT-params4253.hpp"
#elif DSFMT_MEXP == 11213
  #include "dSFMT-params11213.hpp"
#elif DSFMT_MEXP == 19937
  #include "dSFMT-params19937.hpp"
#elif DSFMT_MEXP == 44497
  #include "dSFMT-params44497.hpp"
#elif DSFMT_MEXP == 86243
  #include "dSFMT-params86243.hpp"
#elif DSFMT_MEXP == 132049
  #include "dSFMT-params132049.hpp"
#elif DSFMT_MEXP == 216091
  #include "dSFMT-params216091.hpp"
#else
#ifdef __GNUC__
